...
def Metadata(context):
    ...
    if ALLOWUSAGEANALYTICS == 'yes':
        ...
        SENDANALYTICS = ' --metrics "cloudName:google,region:' + context.properties['region'] + ',bigipVersion:' + context.properties['imageName'] + ',customerId:${CUSTOMERID},deploymentId:${DEPLOYMENTID},templateName:f5-existing-stack-byol-2nic-bigip.py,templateVersion:3.1.0,licenseType:byol"'
    else:
    ...
    metadata = {
                'items': [{
                    ...
                    'value': ('\n'.join(['#!/bin/bash',
                                    ...
                                    'EOF',
                                    'echo \'\' | base64 -d > /config/verifyHash',
                                    ...
                                    '    fi',
                                    'done',
                                    '    f5-rest-node /config/cloud/gce/node_modules/@f5devcentral/f5-cloud-libs/scripts/onboard.js --host localhost --port ' + str(context.properties['mgmtGuiPort']) + ' -o /var/log/cloud/google/onboard.log --log-level ' + str(context.properties['logLevel']) + ' --license ' + str(context.properties['licenseKey1']) + ' >> /var/log/cloud/google/install.log < /dev/null ',
                                    '    wait_bigip_ready',
                                    '    date',
                                    ...
                                    'EOF',
                                    'curl -s -f --retry 20 -o /config/cloud/f5-cloud-libs.tar.gz https://cdn.f5.com/product/cloudsolutions/f5-cloud-libs/v4.11.0/f5-cloud-libs.tar.gz',
                                    ...
                                    'nohup f5-rest-node /config/cloud/gce/node_modules/@f5devcentral/f5-cloud-libs/scripts/runScript.js --file /config/cloud/gce/collect-interface.sh --cwd /config/cloud/gce -o /var/log/cloud/google/interface-config.log --log-level ' + str(context.properties['logLevel']) + ' >> /var/log/cloud/google/install.log < /dev/null',
                                    'nohup f5-rest-node /config/cloud/gce/node_modules/@f5devcentral/f5-cloud-libs/scripts/onboard.js --db provision.managementeth:eth1 --host localhost >> /var/log/cloud/google/install.log < /dev/null',
                                    'reboot',
                                    'EOF',
                                    ...
                                    '   source /usr/lib/bigstart/bigip-ready-functions',
                                    '   wait_bigip_ready',
                                    '   nohup f5-rest-node /config/cloud/gce/node_modules/@f5devcentral/f5-cloud-libs/scripts/onboard.js --host localhost --port 443 --ssl-port ' + str(context.properties['mgmtGuiPort']) + ' -o /var/log/cloud/google/onboard.log --log-level ' + str(context.properties['logLevel']) + ' --install-ilx-package file:///config/cloud/f5-appsvcs-3.5.1-5.noarch.rpm ' + ntp_list + timezone + ' --modules ' + PROVISIONING_MODULES + SENDANALYTICS + ' >> /var/log/cloud/google/install.log < /dev/null ',
                                    '   nohup /config/cloud/gce/custom-config.sh | tee --append /var/log/cloud/google/install.log /var/log/cloud/google/custom-config.log',
