# Deploying the BIG-IP in Google Cloud - Single NIC: Existing Stack with BYOL Licensing
...
This solution uses a Google Deployment Manager Template to launch a single NIC deployment a BIG-IP VE in an Google Virtual Private Cloud, using BYOL (bring your own license) licensing.
