          ...
          'metadata': {
              'items': [{
                  ...
                  'value': (''.join(['#!/bin/bash\n',
                                    ...
                                    '            set hashes(f5-cloud-libs-azure.tar.gz) 90e9162245f204b0c15e5b30c8d7e9d5f110a03002c0bfeaa83e51252119bfc1c4f711dc85d630c8203dab4a6ec373ae2c3777586a3fb1631dc61d7fa095448e\n',
                                    ...
                                    'date\n',
                                    'EOF\n',
                                    'curl -s -f --retry 20 -o /config/cloud/f5-cloud-libs.tar.gz https://raw.githubusercontent.com/F5Networks/f5-cloud-libs/v3.0.0/dist/f5-cloud-libs.tar.gz\n',
