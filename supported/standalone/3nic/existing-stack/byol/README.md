...
This solution uses a Google Deployment Manager Template to launch a 3 NIC deployment a BIG-IP VE in an Google Virtual Private Cloud, using BYOL (bring your own license) licensing.
...
- BYOL: [**f5-existing-stack-byol-3nic-bigip.yaml**](https://github.com/F5Networks/f5-google-gdm-templates/blob/master/supported/standalone/3nic/existing-stack/byol/f5-existing-stack-byol-3nic-bigip.yaml)  
