...
| --- | --- | --- | --- | --- |
| 16.1.0.0 | 0.0.19 | Standalone, Failover, Autoscale | |
| 15.1.2.1 | 0.0.10 | Standalone, Failover, Autoscale | |
| 14.1.4.4 | 0.0.4 | Standalone, Failover, Autoscale | |
| 13.1.4.1 | 0.0.3 | Standalone, Failover, Autoscale | F5 CFE requires BIG-IP 14.1 or later |
