# Deploying the BIG-IP in Google Cloud - 3 NIC: Existing Stack with PAYG Licensing  
...
This solution uses a Google Deployment Manager Template to launch a 3 NIC deployment a BIG-IP VE in an Google Virtual Private Cloud, using PAYG (pay as you go) hourly licensing. 
...
PAYG: [**f5-existing-stack-payg-3nic-bigip.yaml**](https://github.com/F5Networks/f5-google-gdm-templates/blob/master/supported/standalone/3nic/existing-stack/payg/f5-existing-stack-payg-3nic-bigip.yaml)
...
2. [Edit the parameters](#edit-the-yaml-file) in the YAML file as described in this section.
