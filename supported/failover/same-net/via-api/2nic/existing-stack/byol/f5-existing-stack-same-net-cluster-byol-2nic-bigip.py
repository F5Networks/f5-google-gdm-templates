...
def Metadata(context,group, storageName, licenseType):
  ...
  if ALLOWUSAGEANALYTICS in ['yes', 'true']:
      ...
      SENDANALYTICS = ' --metrics "cloudName:google,region:' + context.properties['region'] + ',bigipVersion:' + context.properties['imageName'] + ',customerId:${CUSTOMERID},deploymentId:${DEPLOYMENTID},templateName:f5-existing-stack-same-net-cluster-byol-2nic-bigip.py,templateVersion:3.4.1,licenseType:byol"'
  else:
...
def GenerateConfig(context):
  ...
  FirewallRuleMgmt(context),
  {
    ...
    'properties': Instance(context, 'create', storageName, 'byol', '1', context.properties['availabilityZone1'])
  },{
    'name': instanceName1,
    'type': 'compute.v1.instance',
    'properties': Instance(context, 'join', storageName, 'byol', '2', context.properties['availabilityZone2'])
  },{
    'name': storageName,
