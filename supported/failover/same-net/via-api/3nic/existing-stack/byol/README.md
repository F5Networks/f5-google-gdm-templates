# Deploying the BIG-IP in Google Cloud - HA Cluster (Active/Standby): Existing Stack with BYOL Licensing
...
- [**f5-deployment-template.yaml**](f5-existing-stack-same-net-cluster-byol-3nic-bigip.yaml)
