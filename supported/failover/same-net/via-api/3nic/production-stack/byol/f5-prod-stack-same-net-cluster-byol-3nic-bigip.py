...
def Metadata(context, group, storageName, licenseType):
  ...
  if ALLOWUSAGEANALYTICS == "yes":
    ...
    SENDANALYTICS = ' --metrics "cloudName:google,region:' + context.properties['region'] + ',bigipVersion:' + context.properties['imageName'] + ',customerId:${CUSTOMERID},deploymentId:${DEPLOYMENTID},templateName:f5-prod-stack-same-net-cluster-byol-3nic-bigip.py,templateVersion:v2.2.0,licenseType:byol"'
  else:
