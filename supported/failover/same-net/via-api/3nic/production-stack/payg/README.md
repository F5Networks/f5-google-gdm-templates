...
- [**f5-deployment-template.yaml**](f5-prod-stack-same-net-cluster-payg-3nic-bigip.yaml)
...
After you have edited the YAML file with the appropriate values, save the YAML file in a location accessible from the gcloud command line.  Save the [python file](f5-prod-stack-same-net-cluster-payg-3nic-bigip.py) in the same location.
