...
After you have edited the YAML file with the appropriate values, save the YAML file in a location accessible from the gcloud command line.  Save the [python file](https://github.com/F5Networks/f5-google-gdm-templates/blob/master/experimental/standalone/1nic/learning-stack/byol/f5-learning-stack-byol-1nic-bigip.py) in the same location.
